# go-panikint has moved to [gosentry](https://github.com/kevin-valerio/gosentry), the Go toolchain with a focus on security. It integrates features such as LibAFL fuzzing, go-panikint, and more. 
